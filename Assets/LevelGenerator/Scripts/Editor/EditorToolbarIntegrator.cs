...
namespace LevelGenerator.Scripts.Editor
{
    ...
    public class EditorToolbarIntegrator
    {
        ...
        private const string ToolBarPath = "Assets/LevelGenerator/Scripts/Editor/ToolBarSkin.guiskin";
        private const string LevelGeneratorScenePath = "Assets/LevelGenerator/Scene/LevelGenerator.unity";
